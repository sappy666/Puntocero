  ...
  return (
    <section id="attractions" className="py-24 sm:py-32 px-6 sm:px-12 md:px-16 bg-[#100e0b]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center border-t border-[#4c463d]/30 pt-16">
        {/* Left Column: Image */}
        <div className="md:col-span-5 order-2 md:order-1 zoom-parallax rounded-sm shadow-2xl overflow-hidden">
          <img
            src={t.image}
            alt={t.title}
            className="w-full aspect-square object-cover opacity-85 hover:opacity-100 transition-opacity duration-700"
          />
        </div>
        ...
        <div className="md:col-span-6 md:col-start-7 order-1 md:order-2 space-y-6">
          ...
          <div className="inline-flex items-center gap-3 text-[#cfc5ba] border-b border-[#4c463d]/40 pb-3 font-mono text-xs tracking-widest uppercase">
            <Compass size={18} className="text-[#d1bfa5]" />
